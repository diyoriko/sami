...
- [x] **SM-1000 Переслать 1 пост 3 знакомым** — сделано вручную 03.04
- [x] **SM-1050 Telegram SEO** — описание канала обновлено: «без инвентаря», «10-20 мин», «шея», слоган «Не мотивация. Структура.»
- [x] **SM-1040 Еженедельный дайджест в канал** — крон вс 20:00 МСК. Итоги недели + топ-3 тренировки. `analytics.ts` + `scheduler.ts`

### P0: Growth — узнать откуда рост

- [ ] **SM-1001 Откуда +2 подписчика** — Telegram API не даёт список подписчиков канала. Проверить вручную: настройки канала → подписчики → сортировка по дате. Бот видит только count (18), не кто именно

### P1: Growth (ручная работа)

- [ ] **SM-1053 Зарегистрировать канал в tgstat.ru и telegramchannels.me** — 10 минут, ручная регистрация через сайт
