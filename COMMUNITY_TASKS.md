...
- [ ] **Комментарии в канале** — настройка Telegram: канал @sami_workouts → Discussion → привязать "Сами Daily". Не код
- [ ] **Капча при вступлении в канал** — Telegram Bot API не поддерживает join-события для каналов. Ограничение платформы
...
## SPRINT 5 — вовлечение, рост, лендинг

Статус: **запланирован** | Фокус: growth loops и расширение
