...
- [x] Автопостинг отключён — только ручная публикация через "Опубликовать"
- [ ] **P0: yt-dlp слишком старый (2025.01.15)** — обновление при старте через pip
- [ ] **Проверить:** видео постятся файлом, а не текстом
- [ ] Вернуть автопостинг когда видео стабильно работает
