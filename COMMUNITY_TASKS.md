...
- [ ] **Убрать счётчик из тела поста** — `Сделали: 0` больше не нужен в caption. Счётчик виден только в комментариях. Упрощает caption, убирает зависимость от editMessage
