...
> Заменяет: "Контент-расписание", "Поиск тренировки в канале/боте".
...
- [ ] **Конфиг маппинга** — `SEASON_DAY_MAP` в shared.ts: `dayOfWeek → Category`. Определяет какая категория в какой день. Админ может переопределить (но не в MVP)

#### S2. Хештеги в постах (P1)

- [ ] **Формат хештегов** — каждый пост содержит теги в конце caption: `#стретчинг #спина #начинающий #сезон1`. Категория, основные мышцы, уровень, сезон
- [ ] **Маппинг в shared.ts** — `CATEGORY_HASHTAG: Record<Category, string>` (`stretching → '#стретчинг'`), `DIFFICULTY_HASHTAG`, `MUSCLE_HASHTAG`
- [ ] **poster.ts: добавить теги** — в `formatCaption()` добавить строку с хештегами перед ссылкой на автора. Теги кликабельны в Telegram — открывают поиск по каналу
- [ ] **UGC посты: теги** — при публикации UGC видео добавлять те же хештеги
...
#### S4. Публикация с подсказкой сезона (P1)

- [ ] **Статус: информация о сезоне** — в `/status` админ видит: `Сезон 1 | День 5/21 | Сегодня: 🧘 Стретчинг`. Помогает не запутаться в расписании
- [ ] **Поиск видео: автовыбор категории** — при нажатии "Поиск видео" бот автоматически подставляет категорию дня (из `SEASON_DAY_MAP[dayOfWeek]`). Админ может переопределить, но по умолчанию — категория дня
- [ ] **Предупреждение при несовпадении** — если админ выбирает категорию не по расписанию: «Сегодня по расписанию 🧘 Стретчинг (день 5/21). Публикуем 💪 Силовая?» с кнопками Да/Нет
- [ ] **Caption: день сезона** — в посте добавить строку `День 5/21 · Сезон 1` (после хештегов или в теги)

#### S5. Еженедельный опрос прогресса (P1)
