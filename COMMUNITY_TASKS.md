...
### P0: Модерация — смягчить правила

- [ ] **Ревью всех правил модерации** — сейчас auto-delete ссылок блокирует участников: нельзя отправить видео/ссылку в группу. Сообщество зарождается, жёсткие правила отпугивают. Нужно: (1) составить список всех active правил (антифлуд, ссылки, стоп-лист, ночной режим и т.д.), (2) решить что отключить/смягчить, (3) оставить только anti-spam для ботов. Файл: `moderation.ts`
- [ ] **Разрешить ссылки от верифицированных участников** — после прохождения капчи или N сообщений — разрешить ссылки и видео. Новички (до верификации) — ограничены. Файл: `moderation.ts`
- [ ] **Переделать капчу** — текущая math-капча скучная. Сделать простую и дружелюбную: например, «Какой инвентарь тебе нужен для тренировки в Sami?» → ответ «коврик» / кнопка «🧘 Коврик». Вписывается в бренд, легко для людей, сложно для ботов. Файл: `moderation.ts`
