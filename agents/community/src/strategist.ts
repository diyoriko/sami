...
- В контексте есть proposal-status.md — статусы твоих прошлых предложений (done/accepted/pending). НЕ повторяй accepted и done предложения. Сфокусируйся на новых идеях.
